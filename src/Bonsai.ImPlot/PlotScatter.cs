...
/// <summary>
/// Represents an operator that draws a scatter plot on the current canvas and generates
/// a sequence of notifications whenever the plot is displayed.
/// </summary>
[Description("Draws a scatter plot on the current canvas and generates a sequence of notifications whenever the plot is displayed.")]
public class PlotScatter : PlotCombinator
{
    /// <summary>
    ...
    /// <summary>
    /// Draws a scatter plot on the current canvas using the plot point getter object in the
    ...
    public unsafe IObservable<TSource> Process<TSource>(IObservable<TSource> source) where TSource : IPlotPointGetter
    {
        ...
        {
            ImPlot.PlotScatterG(label, value.Getter, null, value.Count, Flags);
        });
    }
}
